...
#
# Generated by export_simulation on Sun Nov 27 14:18:39 PST 2022
#
################################################################################
...
'-reset_run' switch to the './clk0.sh' script.
...
./clk0.sh -noclean_files

For more information on the script, please type './clk0.sh -help'.
